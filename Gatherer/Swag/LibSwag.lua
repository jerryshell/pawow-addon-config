...
if (create or update) then
	...
	do
		...
		myLib.lootSpells = {
			...
			[GetSpellInfo(13977859)] =  "OPEN", -- Woodworking Apprentice
			[GetSpellInfo(13977882)] =  "OPEN", -- Woodworking Journeyman
			[GetSpellInfo(13977883)] =  "OPEN", -- Woodworking Expert
			[GetSpellInfo(13977884)] =  "OPEN", -- Woodworking Artisan
		}
